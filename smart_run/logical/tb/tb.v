...
begin
  if(cx_trace_file != 0) begin
    if(`tb_retire0) begin
      ...
      // else dp_retire_ex2_vec).
      if(`CPU_TOP.x_aq_top_0.x_aq_core.x_aq_rtu_top.x_aq_rtu_retire.retire_trap_vld
         && !`CPU_TOP.x_aq_top_0.x_aq_core.x_aq_rtu_top.x_aq_rtu_retire.retire_trap_int
         && `CPU_TOP.x_aq_top_0.x_aq_core.x_aq_rtu_top.x_aq_rtu_retire.retire_sync_expt) begin
        $fwrite(cx_trace_file, " exc_cause=%0d",
                `CPU_TOP.x_aq_top_0.x_aq_core.x_aq_rtu_top.x_aq_rtu_retire.retire_trap_vec[4:0]);
      end
      $fwrite(cx_trace_file, "\n");
